...
The [evaluation review](2026-09-12-workflow-evaluation-evidence.md#same-source-proposal-review--2026-09-13) distinguishes portable identities from journal HMACs, host attestations from raw inspection and immutable terminal results from later settlement. It retains the original investigation and leaves the linked ADR proposed / not-started.
