...
The [same-day interrupted-context review](2026-09-14-cancelled-tool-history-and-context.md#proposal-review-addendum--2026-09-14) adds reused-ID and same-group cancellation controls and distinguishes intent from dispatch. Its non-binding corrections cover v3 readers/migration, verified model input versus observation and early history preflight. The proposal remains unaccepted and unimplemented.

The author [accepted the reviewed interrupted-context decision](../adr/2026-09-14-verified-interrupted-tool-context.md#author-acceptance--2026-09-14) on 2026-09-14. It is accepted / not-started. The research and same-day review remain non-binding historical evidence; no findings are rewritten as implementation results. Earlier accepted/partial decisions, the book application admission stop and deferred work remain in place.
