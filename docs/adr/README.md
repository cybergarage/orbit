...
| ---------- | ---------- | -------------- | ----------------------------------------------------------------------------------------------- |
| 2026-09-25 | accepted   | not-started    | [Coding Budgets and Explicit Continuation](2026-09-25-coding-budgets-and-continuation.md) |
...
[Evidence-based Workflow Evaluation](2026-09-12-evidence-based-workflow-evaluation.md) defines the accepted bounded read-only core contract for supplied evidence and comparison, with trial execution, independent grading and export storage owned by applications. Missing measurements and planned-slot denominators remain explicit. At proposal it was proposed / not-started; the author acceptance below and subsequent implementation evidence record accepted / partial. It supersedes none of the eight accepted/partial records and does not authorize candidate selection.
...
The [candidate-selection implementation evidence](2026-09-13-application-owned-workflow-selection.md#implementation-evidence--2026-09-13) records commit `0756433a1e0faa1ce1700f1bf67b0a4b333ec1ea`, 29 targeted tests and 651 full-suite passes on both macOS and Linux. Its status is accepted / partial with null completion. A concrete persistent host, product-specific surfaces and deferred deployment trials remain unqualified; the standard backend is not supplied. The prior maintenance timeout cause and nine earlier partial ADRs remain unchanged.
...
The [additional interrupted-context verification](2026-09-14-verified-interrupted-tool-context.md) records `fc0d72a36f23db45d9003794dce58c33db63861a`, replacement detection through acknowledgement, retained failed closes, process-death and v3 entry/limit checks, and 780 passing tests on each Unix environment. This corrects local implementation gaps without re-adopting the decision. It remains accepted / partial with the ten earlier partial records, author-deferred trials, pending backups and chapter-19 admission stop preserved.

[Graph-aware offline migration verification](2026-09-14-verified-interrupted-tool-context.md#graph-aware-offline-migration-verification--2026-09-15)
records the local correction for old Graph journal v2 maintenance, preserving
