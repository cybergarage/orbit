...
- Use `.agents/skills/orbit-research/SKILL.md` when creating or materially revising reusable research notes, especially for publication comparisons and external implementation investigations.
